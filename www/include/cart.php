    ...
    <div class="bl_betting_slip_box">
        ...
        <div class="betting_slip_text">
            <ul class="betting_slip_top">
                ...
                <li>
                    <span>배당률합계</span>
                    <em><B id="BettingQuota">1.00</B></em>
                </li>
                <li>
                    <span>베팅금액</span>
            ...
            <div class="betting_slip_btn">
                <ol>
                    ...
                    <li class="cart-price" data-money="50000">50,000</li>
                    <li class="cart-price" data-money="100000">100,000</li>
                    <li class="cart-price" data-money="250000">250,000</li>
                    <li class="cart-price" data-money="500000">500,000</li>
                    <li class="cart-price" data-money="1000000">1,000,000</li>
                    <li class="orange cart-price" data-money="<?php echo ($meminfo['M_Money']/2);?>" data-text="half">HALF</li>
                    <li class="orange cart-price" data-money="<?php echo $meminfo['M_Money'];?>" data-text="max">MAX</li>
                    <li class="orange cart-price" data-money="0">RESET</li>
                </ol>
                <h2 id="buyGameBtn" data-max_bet="<?php echo $LEVELLIMITED['Sports_Max_Bet_Money'];?>"  data-max_hit="<?php echo $LEVELLIMITED['Sports_Max_Hit_Mone'];?>">베팅하기</h2>
