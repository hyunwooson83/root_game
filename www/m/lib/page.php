...
<div class="sub_board_page">
<dl>
<?php if ($page != 1) {?>
    <dt class="page_prev" onclick="location.href='<?=$PHP_SELF?>?page=<?=$prev_page,$href?>';"></dt>
<?php } ?>
...
<?php } else { ?>
  <dd onclick="location.href='<?=$PHP_SELF?>?page=<?=$i,$href?>'"><?=$i?></dd>
<?php }} ?>

<?php if ($page != $total_page ) {?>
	<dt  class="page_next" onclick="location.href='<?=$PHP_SELF?>?page=<?=$next_page,$href?>'" ></dt>
<?php } ?>
</dl>
</div>