...
switch( $_POST['HAF_Value_0'] ) {
        ...
        if($row[0]>0){
            ...
            if ( $result->RecordCount() < 1 ){
                ...
                if($_SESSION['IS_MOBILE']=='Y'){
                    echo "<script>parent.parent.location.href = '/m/main/';</script>";
                } else {
                  echo "<script>parent.parent.location.href = '/m/main/';</script>";
                }
            };
    ...
    case "MemberLogout" :
        ...
        unset($_SESSION);
        unset($_SESSION[S_Key]);
        echo "<script>alert('안전하게 로그아웃이 되었습니다.');parent.parent.location.href = '/m/login.php';</script>";
        break;
    ...
    case "MemberModify" :
        ...
        $lib->AlertMSG( "회원정보가 변경되었습니다.", "/m/member/modify.php" , 0, "parent" );
        break;
    ...
    case "MemberJoin" :
        ...
        $lib->AlertMSG( "회원가입이 완료되었습니다. 로그인해주세요.", "/m/login/" , 0, "parent" );
