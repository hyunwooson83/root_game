<?php
  ...
  switch( $_POST['HAF_Value_0'] ) {
    ...
    case "BoardModify" :
        ...
        if($_POST['HAF_Value_9']=='Y'){
            $lib->MovePage( "/m/mypage/board/view/?".$_POST['HAF_Value_5']."&mini=Y", 0, "parent" );
        } else {
            $lib->MovePage( "/m/mypage/{$_POST['HAF_Value_1']}/view/?".$_POST['HAF_Value_5'], 0, "parent" );
        }
    ...
    case "BoardDelete" :
        ...
        $lib->MovePage( "/m/mypage/".$_POST['HAF_Value_2']."/?tn=".$_POST['HAF_Value_2'], 0, "parent" );
      break;
