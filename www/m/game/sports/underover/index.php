...
<div class="nmenu">
    <ul class="nmenu_cate sports">
        ...
        <li onclick="location.href='/m/game/sports/underover/'" class="active">언오버</li>
        ...
        foreach($arr as $list){
            ...
            <ul>
                ...
                <li style="border-bottom:none">
                    <dl>
                        <dd class="betting-btn over-<?php echo $list['G_Key'];?>" data-rate="<?php echo $list['G_QuotaOver'];?>" data-bet="Over" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>">
                            <div>
                                <span><?php echo mb_substr($list['G_Team1'],0,15,'utf-8'); ?></span>
                                <em><var class="arr_up arr_wave">▲</var>&nbsp;<?php echo number_format($list['G_QuotaOver'],2); ?></em>
                            </div>
                        </dd>
                        <dd class="space"></dd>
                        <dd class="center">
                            <div>
                                <em><?php echo $list['G_QuotaUnderOver']; ?></em>
                            </div>
                        </dd>
                        <dd class="space"></dd>
                        <dd class=" betting-btn under-<?php echo $list['G_Key'];?>" data-bet="Under" data-rate="<?php echo $list['G_QuotaUnder'];?>" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>">
                            <div class="right">
                                <em><?php echo number_format($list['G_QuotaUnder'],2); ?><var class="arr_down arr_wave">▼</var></em>
