...
<div class="nmenu">
    <ul class="nmenu_cate sports">
        ...
        <li onclick="location.href='/m/game/sports/WDL/'" class="active">승무패</li>
        ...
        foreach($arr as $list){
            ...
            <ul>
                ...
                <li style="border-bottom:none">
                    <dl>
                        <dd class="betting-btn win-<?php echo $list['G_Key'];?>" data-rate="<?php echo $list['G_QuotaWin'];?>" data-bet="Win" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>">
                            <div>
                        ...
                        <dd class="space"></dd>
                        <dd class="center <?php echo ($list['G_QuotaDraw']>0)?'betting-btn':''; ?> draw-<?php echo $list['G_Key'];?>"  data-rate="<?php echo $list['G_QuotaDraw'];?>"data-bet="Draw" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>">
                            <div>
                                <em><?php echo ($list['G_QuotaDraw']>0)?$list['G_QuotaDraw']:'VS'; ?></em>
                            </div>
                        </dd>
                        <dd class="space"></dd>
                        <dd class="betting-btn lose-<?php echo $list['G_Key'];?>" data-bet="Lose" data-rate="<?php echo $list['G_QuotaLose'];?>" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>">
                            <div class="right">
