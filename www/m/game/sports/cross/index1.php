                                    ...
                                    <div class="game-box game-list" id="game_list_<?php echo $rs['G_ID'];?>" >
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="live-game-count_<?php echo $rs['G_ID'];?>" style="margin-left:5px;">+3</span>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="right-game-list" style=" display: block;">
                            ...
                            <div class="game-box" >
                                <table>
                                    ...
                                    <?php
                                    $que = "SELECT * FROM gamelist_live  WHERE G_State = 'Await' AND status = 1 AND GI_Key = 6046";
                                    //echo $que;
                                    $arr = getArr($que);
                                    if(count($arr)>0){
                                        foreach($arr as $rs){
                                            ...
                                            $market_code_wdl = get_market_code('soccer', $rs['G_ID'],'wdl');
                                            $market_code_handi = get_market_code('soccer', $rs['G_ID'],'handi');
                                            $market_code_ou = get_market_code('soccer', $rs['G_ID'],'ou');

                                            if(!in_array($data['_results'][0]['timeMark'],array('HT','FT'))){
                                                ?>


                                                <!-- 배팅판 2개 시작 야구 승패 -->
                                                <tr id="markets<?php echo $market_code_wdl;?>_<?php echo $rs['G_ID'];?>">
                                                    <td colspan="5" style="width: 409px; padding-left:15px; padding-right:15px;margin-bottom:10px;" height="40">
                                                        <table><tr><td colspan="3" style="width: 100%; text-align: center;  height:30px;">최종 승무패 결과</td></tr>
                                                            <tr>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet home">
                                                                        <span class="live-left"><?php echo (!empty($rs['home_KorName']))?$rs['home_KorName']:$rs['home_name'];?></span>
                                                                        <span class="live-right" id="home_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet draw">
                                                                        <span class="live-left">기준</span>
                                                                        <span class="live-right" id="draw_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet away" style="margin-right:3px;">
                                                                        <span class="live-left"><?php echo (!empty($rs['away_KorName']))?$rs['away_KorName']:$rs['away_name'];?></span>
                                                                        <span class="live-right" id="away_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <!-- 배팅판 2개 끝 -->
                                                <!-- 배팅판 2개 시작 야구 핸디 -->
                                                <tr id="markets<?php echo $market_code_handi;?>_<?php echo $rs['G_ID'];?>">
                                                    <td colspan="5" style="width: 409px; padding-left:15px; padding-right:15px;margin-bottom:10px;" height="40">
                                                        <table>
                                                            <tr><td colspan="2" style="width: 100%; text-align: center;  height:30px;">최종 핸디캡 결과</td></tr>
                                                            <tr>
                                                                <td class="two-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet home">
                                                                        <span class="live-left"><?php echo (!empty($rs['home_KorName']))?$rs['home_KorName']:$rs['home_name'];?></span>
                                                                        <span class="live-right" id="home_handicap_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                                <td class="two-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet away" style="margin-right:3px;">
                                                                        <span class="live-left"><?php echo (!empty($rs['away_KorName']))?$rs['away_KorName']:$rs['away_name'];?></span>
                                                                        <span class="live-right" id="away_handicap_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <!-- 배팅판 3개 시작 야구 핸디 -->
                                                <tr id="markets<?php echo $market_code_ou;?>_<?php echo $rs['G_ID'];?>">
                                                    <td colspan="5" style="width: 409px; padding-left:15px; padding-right:15px;" height="40">
                                                        <table>
                                                            <tr><td colspan="3" style="width: 100%; text-align: center;  height:30px;">최종 오버언더 결과</td></tr>
                                                            <tr>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet home">
                                                                        <span class="live-left"><?php echo (!empty($rs['home_KorName']))?$rs['home_KorName']:$rs['home_name'];?></span>
                                                                        <span class="live-right" id="home_over_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet draw">
                                                                        <span class="live-left">기준</span>
                                                                        <span class="live-right" id="overunder_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                                <td class="three-bet-btn">
                                                                    <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet away" style="margin-right:3px;">
                                                                        <span class="live-left"><?php echo (!empty($rs['away_KorName']))?$rs['away_KorName']:$rs['away_name'];?></span>
                                                                        <span class="live-right" id="away_under_rate_<?php echo $rs['G_ID'];?>"></span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                ...
                success : function(data){
                    ...
                    for(var i=0 ; i<data.length;i++) {
                        if (data[i]['timeStatus'] == 3) {
                            ...
                            if (data[i]['markets']['<?php echo $market_code_wdl;?>']['suspended'] == false) {
                                var home_rate = parseFloat(data[i]['markets']['<?php echo $market_code_wdl;?>']['matchOdds'][0]['odds']);
                                var draw_rate = parseFloat(data[i]['markets']['<?php echo $market_code_wdl;?>']['matchOdds'][1]['odds']);
                                var away_rate = parseFloat(data[i]['markets']['<?php echo $market_code_wdl;?>']['matchOdds'][2]['odds']);
                                $('#home_rate_' + data[i]['gid']).text(home_rate);
                                $('#draw_rate_' + data[i]['gid']).text(home_rate);
                                $('#away_rate_' + data[i]['gid']).text(away_rate);
                                $('#markets<?php echo $market_code_wdl;?>_' + data[i]['gid']).show();
                            } else {
                                $('#markets<?php echo $market_code_wdl;?>_' + data[i]['gid']).hide();
                            }

                            /* 핸디캡 최종 결과*/


                            if (data[i]['markets']['<?php echo $market_code_handi;?>']['suspended'] == false) {
                                var home_rate = parseFloat(data[i]['markets']['<?php echo $market_code_handi;?>']['matchOdds'][0]['odds']);
                                var away_rate = parseFloat(data[i]['markets']['<?php echo $market_code_handi;?>']['matchOdds'][1]['odds']);
                                var home_base_rate = data[i]['markets']['<?php echo $market_code_handi;?>']['matchOdds'][0]['option'];
                                var away_base_rate = data[i]['markets']['<?php echo $market_code_handi;?>']['matchOdds'][1]['option'];
                                $('#home_handicap_rate_' + data[i]['gid']).text(home_rate + '[' + home_base_rate + ']');
                                $('#away_handicap_rate_' + data[i]['gid']).text(away_rate + '[' + away_base_rate + ']');
                                $('#markets<?php echo $market_code_handi;?>_' + data[i]['gid']).show();
                            } else {
                                $('#markets<?php echo $market_code_handi;?>_' + data[i]['gid']).hide();
                            }
                            ...
                            if (data[i]['markets']['<?php echo $market_code_ou;?>']['suspended'] == false) {
                                var home_rate = parseFloat(data[i]['markets']['<?php echo $market_code_ou;?>']['matchOdds'][0]['odds']);
                                var away_rate = parseFloat(data[i]['markets']['<?php echo $market_code_ou;?>']['matchOdds'][1]['odds']);
                                var base_rate = data[i]['markets']['<?php echo $market_code_ou;?>']['matchOdds'][0]['option'];
                                $('#home_over_rate_' + data[i]['gid']).text(home_rate);
                                $('#away_under_rate_' + data[i]['gid']).text(away_rate);
                                $('#overunder_rate_' + data[i]['gid']).text(base_rate);
                                $('#markets<?php echo $market_code_ou;?>_' + data[i]['gid']).show();
                            } else {
                                $('#markets<?php echo $market_code_ou;?>_' + data[i]['gid']).hide();
                            }
