...
if($SITECONFIG['Ladder_Stop_YN'] == 'Y'){
    echo "<script>swal('','파워사다리 게임이 점검중입니다.','warning');
    ...
    $game_type_gubun = "파워사다리";


    $pl = $MINIGAME_RATE['MG_PwLadder'];
    $pl = explode("|",$pl);
?>
    ...
    <div id="sub_wrap">
        ...
        <div class="minigame_wrap">
            ...
            <div class="minigame_screen">
                <div><iframe id="game_frame" src="http://ntry.com/scores/power_ladder/main.php" frameborder="0" border="0" scrolling="no"></iframe></div>
            </div>
            ...
            <dl class="mini_footinfo">
                <dt>알아두세요!</dt>
                <dd><code>·</code><font>나눔로또에서 제공하는 파워볼을 기본으로 진행하는 게임입니다.</font></dd>
                <dd><code>·</code><font>나눔로또 파워볼 기준 파워사다리 중계는 5분에 한번씩 매 <b>2분 45초, 7분 45초</b>에 게임이 실행됩니다.</font></dd>
                <dd><code>·</code><font>출발점은 일반볼 첫번째 숫자가 <b>홀일 경우 좌출발, 짝일 경우 우출발</b> 입니다.</font></dd>
                <dd><code>·</code><font>줄갯수는 일반볼 첫번째 숫자가 <b>1~14일 경우 3줄, 15~28일 경우 4줄</b>입니다.</font></dd>
    ...
    <script>
        ...
        var config_bet_finish_time = parseInt("<?php echo $SITECONFIG['pwladder_bet_time']; ?>");
        var game_code = 'PBL';
    ...
    <script src="/m/js/powerball.js"></script>
