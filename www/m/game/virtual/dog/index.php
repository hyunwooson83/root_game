...
if($SITECONFIG['Dog_Stop_YN'] == 'Y'){
    echo "<script>swal('','개경주 게임이 점검중입니다.','warning');
        setTimeout(function(){location.href = '/m/main/';},2000);</script>;
        ";
}
// 풀타임 - 승무패
$offset = $_GET['offset'];
...
?>
    ...
    <div class="nmenu">
        <ul class="nmenu_cate nmenu_cate3">
            ...
            <li onclick="location.href='/m/game/virtual/dog/'" class="active" style="width: 33.3%;">가상개경주</li>
        </ul>
    </div>
    ...
    <div id="sub_wrap">
        ...
        <div class="game_display">
            <iframe src="https://b2.nusub365.com?vn=4&sw=320&sh=240" scrolling="no" width="320" height="240"></iframe>
        </div>
        ...
        <div class="sports_list">
            ...
            <!-- League start { -->
            <h1>
                <span><img src="/mobile/img/sub/icon_soccer.png" /></span>가상개경주
