<?php
    ...
    if($user_id != false) {
        ...
        $private = "C7F4CAD22CFEA245E98A6E790D4F72F0lang=kr&operatorID=beanpole&platform=html5&thirdPartyCode={$gcode}&time={$time}&userID={$user_id}&vendorID=0";
