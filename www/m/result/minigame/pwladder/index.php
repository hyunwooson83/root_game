    ...
    <div id="sub_wrap">
        ...
        <div class="sub_mypage_wrap">
            ...
            <ul id="type_select_l" class="type_select_list">
                ...
                <li onclick="location.href='/m/result/minigame/pwladder/'" class="active">파워사다리</li>
...
GROUP BY G_Num2";
        ...
        <table class="sub_board_list">
            <thead>
            <tr>
                <td>파워사다리 경기 결과리스트 <dfn>1,274</dfn></td>
            </tr>
            </thead>
            <tbody>
            <?php
                    ...
                    <tr>
                        <td style="padding:0">
                            ...
                            <h1 class="sub_board_bet">
                                <span><img src="/mobile/img/sub/icon_mini.png"></span> 파워사다리
