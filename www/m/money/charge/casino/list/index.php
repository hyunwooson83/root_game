...
?>
    ...
    <div id="sub_wrap">
        ...
        <div class="sub_title">
            <h1>
                <span>카지노머니 충전/환전내역</span>
                <em>MONEY CHARGE LIST</em>
            </h1>
            <ul class="sub_title_category">
                <li onclick="location.href='<?php echo $mobile_path;?>/money/charge/casino'">충전/환전하기</li>
                <li onclick="location.href='<?php echo $mobile_path;?>/money/charge/casino/list/'"  class="active">충전/환전내역</li>
        ...
        <div class="sub_mypage_wrap">
            ...
            <ul class="sub_cash_list">
                ...
                $where = " 1  AND R_Type2 = 'Money' AND R_Money > 0 AND a.M_Key = '{$_SESSION['S_Key']}' AND R_Casino_YN = 'Y' ";
                ...
                if($total_article > 0){
                    ...
                    foreach($arr as $list){
                        ...
                        ?>
                        <li>
                            <em>신청금액 [<?php echo ($list['R_Type1']=='Charge')?'충전':'환전';?>] <b><?php echo number_format($list['R_Money']); ?></b></em>
