    ...
    <div id="sub_wrap">
        ...
        <div class="sub_board">
            ...
            <div class="sub_board_write">
                <div><input type="text" name="b_subject" id="b_subject" placeholder="제목을 입력해주세요." /></div>
                <!--<div><a class="b_list" href="/mobile/board_write_bettinglist.html" target="_blank">베팅내역 첨부</a></div>-->
                <div class="text"><textarea name="b_content" id="summernote"  placeholder='내용을 입력해주세요.'></textarea></div>
            </div>
