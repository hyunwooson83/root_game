...
$where = " 1 AND M_Key = {$_SESSION['S_Key']} AND BG_Visible = '1' AND  BG_Gubun IN ('soccerw') ";
    ...
    <div id="sub_wrap">
        <div class="sub_title">
            <ul class="sub_title_category">
                ...
                <li onClick="location.href='/m/mypage/betlist/virtual/'" class="active">가상게임</li>
            </ul>
            <h1>
                <span>가상게임 베팅내역</span>
            ...
            if(count($arr)>0){
                foreach($arr as $rs) {
                    ...
                    <fieldset>
                        ...
                        <div>
                            <!--<a href="">베팅취소</a>--> &nbsp;<a href="">삭제</a> &nbsp;<a href="javascript:;" class="betting-upload">내역올리기</a>
                        </div>
                    </fieldset>
                    <?php $cnt++; }} else { ?>
                <ul>
