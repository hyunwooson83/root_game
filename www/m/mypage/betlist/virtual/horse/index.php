    ...
    <div id="sub_wrap">
        ...
        <div class="sub_mypage_wrap">
            ...
            <ul id="type_select_l" class="type_select_list">
                ...
                <li onclick="location.href='/m/mypage/betlist/virtual/horse/'" class="active">가상경마</li>
                <li onclick="location.href='/m/mypage/betlist/virtual/dog/'">가상개경주</li>
            </ul>
            <!-- 경기검색 { -->
                ...
                foreach($rs as $rs){
                    ...
                    <tr>
                        <td>
                            <!-- 베팅내역 { -->
                            <div>
                                <dfn class="font_gobet">No. <?php echo $rs['BG_Key'];?> &nbsp; <span>가상축구</span></dfn>
                            ...
                            <fieldset>
                                ...
                                <dl>
                                    <dt>베팅내역</dt>
                                    <dd class="blue"><?php echo $rs['BGL_ResultChoice'];?>번마</dd>
                                    <dt>적중상태</dt>
