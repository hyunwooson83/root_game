...
$where = " 1 AND c.GL_Key IN (38918) AND DATE_FORMAT(BG_BuyDate,'%Y-%m-%d') BETWEEN '{$startDate}' AND '{$endDate}' AND BG_Visible = 1 AND b.M_Key = '{$_SESSION['S_Key']}' ";
...
?>
    <div id="sub_wrap">
        <div class="sub_title">
            ...
            <h1>
                <span>가상축구 베팅내역</span>
                <em>VIRTUAL SOCCER BETTING LIST</em>
            </h1>
        </div>
