...
$where = " 1 AND c.GL_Key IN (11,12,13,14,15) AND DATE_FORMAT(BG_BuyDate,'%Y-%m-%d') BETWEEN '{$startDate}' AND '{$endDate}' AND BG_Visible = 1 AND b.M_Key = '{$_SESSION['S_Key']}' ";
    ...
    <div id="sub_wrap">
        ...
        <div class="sub_mypage_wrap">
            ...
            <ul id="type_select_l" class="type_select_list">
                ...
                <li onclick="location.href='/m/mypage/betlist/minigame/pwladder/'" class="active">파워사다리</li>
                <!--<li onclick="location.href='/mobile/mypage/list_speedkino.html'">스피드키노</li>-->
                <li onclick="location.href='/m/mypage/betlist/minigame/kenoladder/'">키노사다리</li>
            </ul>
            <!-- 경기검색 { -->
        ...
        <table class="sub_board_list sub_board_list_betlist">
            ...
            if($total_article > 0){
                ...
                foreach($rs as $rs){
                    ...
                    if(in_array($rs['GL_Key'],array(11))){
                    ...
                    } else if(in_array($rs['GL_Key'],array(12))){
                        if($rs['BGL_ResultChoice']=='Odd'){
                    ...
                    } else if(in_array($rs['GL_Key'],array(13))){
                        if($rs['BGL_ResultChoice']=='Odd'){
                    ...
                    } else if(in_array($rs['GL_Key'],array(14))){
                        if($rs['BGL_ResultChoice']=='Odd'){
                    ...
                    } else if(in_array($rs['GL_Key'],array(15))){
                        if($rs['BGL_ResultChoice']=='Odd'){
                    ...
                    <tr>
                        <td>
                            <!-- 베팅내역 { -->
                            <div>
                                <dfn class="font_gobet">No. <?php echo $rs['BG_Key'];?> &nbsp; <span>파워사다리</span></dfn>
