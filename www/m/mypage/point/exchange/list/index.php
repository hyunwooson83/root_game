...
<?php
    ...
    $where = " 1 AND R_Type1 = 'Charge' AND R_Type2 = 'Point' ";
...
?>
    ...
    <div class="sub_bg">
        <div class="sub_wrap type2">
            <div class="sub_title">
                <div class="title1">보유포인트 전환목록</div>
                <div class="title2">POINT EXCHANGE LIST</div>
            </div>
            <div class="board_wrap board2">
                ...
                <table class="qna_list">
                    ...
                    if($total_article > 0){
                        ...
                        $que = "
                                    SELECT 
                                        R_Point, R_RegDate, R_ResultDate, R_State
                                    FROM 
                                        {$tb} 
                                    WHERE 
                                         {$where}                                    
                        ...
                        foreach($arr as $list){
                            ...
                            <tr>
                                ...
                                <td><div style="text-align: right; font-size:15px; font-weight: bold;"><?php echo number_format($list['R_Point']); ?>P</div></td>
