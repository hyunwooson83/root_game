...
?>
    ...
    <div id="sub_wrap">
        ...
        <div class="sub_title">
            ...
            <ul class="sub_title_category">
                ...
                <li onclick="location.href='/m/mypage/point/exchangelist/'" class="active">포인트전환내역</li>
            </ul>
        </div>
        ...
        <div class="sub_mypage_wrap">
            <ul class="sub_member_top five">
                <li>
                    <em>잔여 포인트</em>
                    <var></var>
                    <span class="hit"><?php echo number_format($meminfo['M_Point']); ?>P</span>
                </li>
                <li>
                    <em>당월 적립포인트</em>
                    <var></var>
                    <span class="today"><?php echo number_format($row['SP']);?>P</span>
                </li>
                <li>
                    <em>전월 적립포인트</em>
                    <var></var>
                    <span class="month"><?php echo number_format($row['PP']);?>P</span>
                </li>
                <li>
                    <em>총 누적포인트</em>
                    <var></var>
                    <span class="year"><?php echo number_format($row['TP']);?>P</span>
                </li>
                <li>
                    <em>총 사용포인트</em>
                    <var></var>
                    <span class="give"><?php echo number_format($row['MP']);?>P</span>
                </li>
            </ul>
            <div class="sub_searchbox">
                <div>
                    <h1>
                        <input type="text" class="style_input date" name="startDate" id="startDate" value="<?php echo date('Y-m-d'); ?>">
                        &nbsp;&nbsp;~&nbsp;&nbsp;
                        <input type="text" class="style_input date" name="endDate" id="endDate" value="<?php echo date('Y-m-d'); ?>">
                        <ol>
            ...
            <ul class="sub_cash_list">
                ...
                $where = " 1 AND PI_Type = 'PointConvert' AND M_Key = '{$_SESSION['S_Key']}'";
                ...
                ?>
                <li>
                    <em>전환포인트 <b>+<?php echo number_format($list['PI_Point']);?></b></em>
                    <!--<em>사용포인트 <b>-90</b></em>-->
    ...
    <script>
        $(document).ready(function(){
            $('#sub_wrap > div.sub_mypage_wrap > div.sub_searchbox > div > h1 > ol > li').on('click',function(){
