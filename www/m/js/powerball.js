function timeHandler(server_min,server_sec){
    ...
    //if(ct_start<0) ct_start = 299;
    var ct_remain = 300 - parseInt(ct_start);
    //console.log('남은 분:'+min_remind+'남은 초는:'+return_count+' ct_remain->'+ct_remain);
    if(ct_remain>300){
        $('#ntry_min').prop('value',4);
    }
    ...
    $('#remaind_time, #powerball_time_box, #powerball_time_box2').text(ct_sec1+':'+ct_sec2);
    ...
    $('#keno_time_box1, #keno_time_box2').text(ct_sec3+':'+ct_sec4);
        ...
        swal({
            ...
            .then((isConfirm)=>{
                if(isConfirm){
                    ...
                    var jsonurl =  "/m/games/prc/betting_list_delete.php";
