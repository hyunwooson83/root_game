            ...
            <div class="game_result_wrap">
                <div class="result_s_choice">
                    ...
                    <ul class="result_s_list2">
                        <li onclick="location.href='/result/minigame/power/'">파워볼게임</li>
                        ...
                        <li class="active" onclick="location.href='/result/minigame/kenoladder/'">키노사다리</li>
                    </ul>
                </div>
                        ...
                        <table class="table-black minigame normal">
                            ...
                            if($total_article > 0){
                                ...
                                foreach($arr as $rs){
                                    ...
                                    <tr> <!-- TITLE -->
                                        <th colspan="4">
                                            <!--<img src="/_go/renewal/img/icon_minigame.png" />--><span>키노사다리 게임</span><code><?php echo date("m-d",strtotime($rs['G_Datetime'])); ?><strong><?php echo $rs['G_Num']; ?>회차</strong></code>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>게임일시</td>
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM gamelist_other WHERE G_Num2 = '{$rs['G_Num2']}' AND DATE_FORMAT(G_Datetime,'%Y-%m-%d') = '{$startDate}' AND GI_Key = 3  ORDER BY GL_Key ASC LIMIT 5";
                                    //echo $sql;
                                    $list = getArr($sql);
