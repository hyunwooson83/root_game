...
$where = " 1 AND GL_Key = 38918 AND G_State IN ('Stop','End') ";
            ...
            <div class="game_result_wrap">
                <div class="result_s_choice">
                    ...
                    <ul class="result_s_list2">
                        <li class="active" onclick="location.href='/result/virtual/soccer/'">가상축구</li>
                        ...
                        <li onclick="location.href='/result/virtual/dog/'">가상개경주</li>
                    </ul>
                </div>
                        ...
                        <table class="table-black minigame normal">
                            ...
                            if($total_article > 0){
                                ...
                                foreach($arr as $rs){
                                    ...
                                    <tr> <!-- TITLE -->
                                        <th colspan="5">
                                            <!--<img src="/_go/renewal/img/icon_minigame.png" />--><span>가상축구 게임</span><code><?php echo date("m-d",strtotime($rs['G_Datetime'])); ?><strong><?php echo date("H-i",strtotime($rs['G_Datetime'])); ?></strong></code>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>게임일시</td>
                                    ...
                                    foreach($list as $list){
                                        ...
                                        <tr>
                                            ...
                                            <td><font class="mypage-grnfont"><?php echo $list['G_Team1']; ?></font></td>
                                            <td><font class="mypage-grnfont"><?php echo $list['G_ResultScoreWin']; ?> : <?php echo $list['G_ResultScoreLose']; ?></font></td>
                                            <td><font class="mypage-grnfont"><?php echo $list['G_Team2']; ?></font></td>
