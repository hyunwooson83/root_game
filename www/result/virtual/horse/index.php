...
$where = " 1 AND GL_Key = 38919 AND G_State IN ('Stop','End') ";
            ...
            <div class="game_result_wrap">
                <div class="result_s_choice">
                    ...
                    <ul class="result_s_list2">
                        ...
                        <li class="active" onclick="location.href='/result/virtual/horse/'">가상경마</li>
                        ...
                        <table class="table-black minigame normal">
                            ...
                            if($total_article > 0){
                                ...
                                foreach($arr as $rs){
                                    ...
                                    <tr> <!-- TITLE -->
                                        <th colspan="3">
                                            <!--<img src="/_go/renewal/img/icon_minigame.png" />--><span>가상경마 게임</span><code><?php echo date("m-d",strtotime($rs['G_Datetime'])); ?><strong><?php echo date("H-i",strtotime($rs['G_Datetime'])); ?></strong></code>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>게임일시</td>
