...
if($chkMobile == true){
    ...
    $total_item = 0;
    /*$que = "SELECT GI_Key, COUNT(DISTINCT(inPlayMatchIdx)) AS cnt FROM gamelist WHERE G_Locked = 1 AND G_Datetime > NOW() AND GI_Key IN (6046,35232,48242,154830,154914) AND G_SubType NOT IN (60562,60561) AND G_OType1= 'G' AND G_Type2 = 'UnderOver' AND G_Type1 = 'Full' GROUP BY GI_Key";
    $item_cnt = getArr($que);
    ...
    $where = " 1  AND G_Datetime > NOW() AND G_Type2 = 'UnderOver' AND G_Type1 = 'Full' AND G_SubType NOT IN (60562,60561) AND b.GL_State = 'Normal' AND G_State = 'Await'  ";
    ...
    if(!empty($search_order)){
        ...
        $order_by = " ORDER BY G_Datetime ASC, inPlayMatchIdx ASC, G_Type2 DESC, G_QuotaUnderOver ASC  ";
    }
        ...
        <div class="center_con">
            <div class="score_board_category">
                <ul>
                    ...
                    <li onclick="location.href='/game/sports/underover/'" class="active">언오버<var></var></li>
                        ...
                        if($total_article > 0){
                            ...
                            foreach($arr as $list){
                                ...
                                <tr>
                                    ...
                                    <td title="승/홈/오버">
                                        <div class="bl_btn bl_text_btn long betting-btn over-<?php echo $list['G_Key'];?>" data-bet="Over" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>" data-bet_cnt="<?php echo member_game_bet_cnt($_SESSION['S_Key'],$list['G_Key'],'Over');?>">
                                            <span class="left"><?php echo mb_substr($list['G_Team1'],0,30,'utf-8'); ?></span>
                                            <span class="right"><em class="blink"><img src="/img/pop_live_icon3.png"></em><?php echo number_format($list['G_QuotaOver'],2); ?></span>
                                        </div>
                                    </td>
                                    <td class="min_space"></td>
                                    <td title="무/핸/합">
                                        <div class="bl_btn bl_text_btn middle "><?php echo $list['G_QuotaUnderOver']; ?></div>
                                    </td>
                                    <td class="min_space"></td>
                                    <td title="패/원정/언더" style="padding-right:8px;" >
                                        <div class="bl_btn bl_text_btn long betting-btn under-<?php echo $list['G_Key'];?>" data-bet="Under" data-gkey="<?php echo $list['G_Key']; ?>" data-glist="<?php echo $list['inPlayMatchIdx']; ?>" data-bet_cnt="<?php echo member_game_bet_cnt($_SESSION['S_Key'],$list['G_Key'],'Under');?>">
                                            <span class="left"><?php echo number_format($list['G_QuotaUnder'],2); ?><em class="blink"><img src="/img/pop_live_icon4.png"></em></span>
