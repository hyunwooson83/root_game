...
if($SITECONFIG['Horse_Stop_YN'] == 'Y'){
    echo "<script>swal('','경마 게임이 점검중입니다.','warning');
                                ...
                                <div class="games-wrap" id="mini_boxwrap">
                                    <div id="mini_box_right">
                                        <div class="mini_gamemovie" style="margin-top:20px;">
                                            <iframe src="http://lineup99.com/bet365/vhorse.asp?src=https://www.bet365.com&m=3" scrolling="no" width="520" height="300"></iframe>
                                        </div>
                                        <!-- 파워볼 베팅 타이머 -->
                                                ...
                                                <table width="80%" border="1">
                                                    <tr>
                                                        ...
                                                        for($i=0;$i<count($rate);$i++){
                                                            ...
                                                            >
                                                                <div class=" _rate">
                                                                    <span class="_text_left"><img src="/img/horse/SilkSmall_<?php echo ($i+1); ?>.png" style="height:25px;"></span>
                                        ...
                                        <div class="betting-history mini_table betting-history">
                                            ...
                                            <table class="palign" style="margin-bottom: 10px;">
                                                ...
                                                $where = " 1 AND c.GL_Key = 38919 AND a.M_Key = {$_SESSION['S_Key']} AND BG_Visible = '1' ";
                                                #성명으로 정렬시
                                                ...
                                                if(count($arr)>0){
                                                    foreach($arr as $arr){
                                                        ...
                                                        if(in_array($arr['GL_Key'],array(38919,38920))){

                                                            $betting_text = "<span style='color:#31ff39'>" .($arr['BGL_ResultChoice']+1)."번마</span>";
                                                            $betting_game_text = "가상경마";
                                                        }
                                                        ?>
                                                        <tr>
