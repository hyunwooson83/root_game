...
<div class="sub_bg">
    <div class="sub_wrap type2">
        <div class="sub_title">
            <div class="title1">파워스피드덩크</div>
            <div class="title2">POWER SPEED DUNK GAME</div>
        </div>
        <!--<ul class="sub_menu">
                                        ...
                                        <ul class="mini_bettingbtn">
                                            ...
                                            <li>
                                                <dl>
                                                    ...
                                                    >
                                                        <label>
                                                            <img src="/img/mini_btn_success.png">
                                                        </label>
