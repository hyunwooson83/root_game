...
<div class="sub_bg">
    <div class="sub_wrap type2">
        <div class="sub_title">
            <div class="title1">파워사다리</div>
            <div class="title2">POWERLADDER GAME</div>
        </div>
        <!--<ul class="sub_menu">
                                    ...
                                    <div id="mini_box_right">
                                        <div class="mini_gamemovie">
                                            <div class="power_ladder">
                                                <iframe src="http://ntry.com/scores/power_ladder/live.php" scrolling="no"></iframe>
                                            </div>
                                        </div>
                                        <!-- 파워볼 베팅 타이머 -->
                                        ...
                                        <div class="betting-history mini_table betting-history">
                                            ...
                                            <table class="palign" style="margin-bottom: 10px;">
                                                ...
                                                $where = " 1 AND a.M_Key = {$_SESSION['S_Key']} AND BG_Visible = '1' AND b.GL_Key IN (11,12,13,14,15)";
                                                #성명으로 정렬시
                                                ...
                                                if(count($arr)>0){
                                                    foreach($arr as $arr){
                                                        ...
                                                        if(in_array($arr['GL_Key'],array(11))){
                                                        ...
                                                        } else if(in_array($arr['GL_Key'],array(12))){
                                                            if($arr['BGL_ResultChoice']=='Odd'){
                                                        ...
                                                        } else if(in_array($arr['GL_Key'],array(13))){
                                                            if($arr['BGL_ResultChoice']=='Odd'){
                                                        ...
                                                        } else if(in_array($arr['GL_Key'],array(14))){
                                                            if($arr['BGL_ResultChoice']=='Odd'){
                                                        ...
                                                        } else if(in_array($arr['GL_Key'],array(15))){
                                                            if($arr['BGL_ResultChoice']=='Odd'){
