...
<div class="sub_bg">
    <div class="sub_wrap type2">
        <div class="sub_title">
            <div class="title1">스피드홈런</div>
            <div class="title2">SPEED HOMERUN GAME</div>
        </div>
        <!--<ul class="sub_menu">
                                        ...
                                        <ul class="mini_bettingbtn">
                                            ...
                                            <li>
                                                <dl>
                                                    ...
                                                    >
                                                        <label>
                                                            <img src="/img/mini_btn_homerun.png">
                                                        </label>
