...
<div class="sub_bg">
    <div class="sub_wrap type2">
        <div class="sub_title">
            <div class="title1">벳이스트 크리켓</div>
            <div class="title2">CRICKET GAME</div>
        </div>
        <!--<ul class="sub_menu">
                                        ...
                                        <ul class="mini_bettingbtn">
                                            <li>
                                                <dl>
                                                    ...
                                                    >
                                                        <label>
                                                            <img src="/img/mini_btn_score.png">
                                                        </label>
