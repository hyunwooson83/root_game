<dl class="mini_bettingslip" id="games-betslip">
    ...
    <dd>
        ...
        <ul>
            ...
            <li>
                ...
                <code data-value="30,000" class="select-amount btn-select-coin" data-money="30000">30,000</code>
    ...
    <div class="bet-disable" id="preloader" >
        <div style="position: absolute; font-size:30px; left: 30%;" id="disable-text">잠시만 기다려주세요. 다음 게임을 준비중입니다.</div>
    </div>
