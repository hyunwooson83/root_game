                ...
                <div class="score_board_contents">
                    ...
                    <div class="right-game-detail" style="width: 538px; background-color: #131313;">
                        ...
                        <div class="right-game-list" style=" display: block;">
                            <!-- 경기 목록 시작 -->
                            <div class="game-box" id="right_betting_box" >
                                <table>
                                    <thead>
                                    <colgroup>
                                        <col width="5%">
                                        ...
                                        <td colspan="5" style="width: 409px; padding-left:15px; padding-right:15px;" height="40">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="four-bet-btn">
                                                        <div class="bl_btn bl_text_btn long betting-btn win-65486 live-bet away">
                                                            <span class="live-left">Kale 1957...</span>
                                                            <span class="live-right">1.16</span>
                                                        </div>
                                                    </td>
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    for(var i=0 ; i<data.length;i++){
                        ...
                        var html = '';
                        if(data[i]['markets']['_00_90_34']!=''){
                            var home_team = data[i]['markets']['_00_90_34']['matchOdds'][0]['oddsName'];
                            var away_team = data[i]['markets']['_00_90_34']['matchOdds'][1]['oddsName'];
