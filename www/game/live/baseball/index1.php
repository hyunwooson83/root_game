...
$total = 0;
$que = "SELECT COUNT(G_ID) as item_cnt, GI_Key FROM gamelist_live WHERE 1 AND status = 1 AND make_yn = 'y' GROUP BY GI_Key ";
$arr = getArr($que);
if(count($arr)>0){
    foreach($arr as $arr){
        ...
        <div class="center_con" style="width:960px;">
            ...
            <div class="score_board_contents">
                <div class="root_display" style="background: url('/img/bg_bl_title.jpg');">
                    <font>라이브</font><B>></B> 야구(<?php echo $rm['154914']['cnt'];?>)
                    <ul>
                ...
                <div class="score_board_sub_category">
                    <table class="five">
                        <tr>
                            ...
                            <td onclick="location.href = '../soccer/';">
                            ...
                            <td class="active" onclick="location.href = '../baseball/';">
                ...
                <div class="bl_live_betting_middle cross" style="width: 960px; display: flex; justify-content: start;">
                    ...
                    <div class="left-game-list">
                        ...
                        $que = "SELECT * FROM gamelist_live  WHERE G_State = 'Await' AND status = '1' AND matchDateTime < NOW() AND GI_Key = '154914' AND make_yn = 'y'";
                        //echo $que;
                        $arr = getArr($que);
                        $arr_cnt = count($arr);
                        if($arr_cnt>0){
                            foreach($arr as $rs){
                                ...
                                <div class="game-box game-list left-game-list-box" data-gid="<?php echo $rs['G_ID'];?>" data-gkey="<?php echo $rs['G_Key'];?>" data-wdl="<?php echo $market_code_wdl;?>" data-handicap="<?php echo $market_code_handi;?>" data-ou="<?php echo $market_code_ou;?>" id="game_list_<?php echo $rs['G_ID'];?>" >
                                    <table>
                                        ...
                                        <tr>
                                            <td height="40"><img src="/img/icon_baseball.png" style="width: 17px; line-height: 40px; padding-left: 10px; "> </td>
                                            <td>야구 : <?php echo mb_substr($rs['league_name'],0,22,'utf-8');?></td>
                                            <td>
                            ...
                            <table>
                                ...
                                <tr style="display:none;" class="markets-wdl">
                                    <td colspan="5" style="width: 100%; padding-left:15px; padding-right:15px;margin-bottom:10px;" height="40">
                                        <table>
                                            <tr>
                                                <td colspan="3" style="width: 100%; text-align: center;  height:30px;">최종 승패</td>
                                            </tr>
                                            <tr>
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet Win" data-type1="Full" data-type2="WDL" data-bet="Win" data-market="wdl">
                                                        ...
                                                        <span class="live-right"><span  class="win-rate"></span>
                                                    </div>
                                                </td>
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet Lose" data-type1="Full" data-type2="WDL" data-bet="Lose" data-market="wdl"  style="margin-right:3px;">
                                                        ...
                                                        <span class="live-right"><span class="away-rate"></span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet HandiWin" data-type1="Full" data-type2="Handicap" data-bet="HandiWin" data-market="handicap">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right" >[<span class="home-handicap-option">0.5</span>] <span class="home-handicap-rate"></span></span>
                                                    </div>
                                                </td>
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet HandiLose" data-type1="Full" data-type2="Handicap" data-bet="HandiLose" data-market="handicap" style="margin-right:3px;">
                                                        <span class="live-left away-team-name">원정팀명</span>
                                                        <span class="live-right" >[<span class="away-handicap-option">-0.5</span>] <span class="away-handicap-rate"></span></span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr style="display:none ;" class="markets-handicap-other">
                                    <td colspan="5" style="width: 100%; padding-left:15px; padding-right:15px;margin-bottom:10px;" height="40">
                                        <table>
                                            <tr><td colspan="2" style="width: 100%; text-align: center;  height:30px;">핸디캡 기타기준점</td></tr>
                                            <tr class="handicap-other-0" style="display: none;">
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live win-'+gid+' live-bet HandiWin">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right" >[<span class="HandiWin-option-0"></span>] <span class="HandiWin-rate-0"></span></span>
                                                    </div>
                                                </td>
                                                <td class="two-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live lose-'+gid+' live-bet HandiLose" style="margin-right:3px;">
                                                        <span class="live-left away-team-name">원정팀명</span>
                                            ...
                                            <tr>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet  Over" data-type1="Full" data-type2="UnderOver" data-bet="Over" data-market="underover">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon3.png"></span> <span  class="over-rate"></span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                ...
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live live-bet Under " data-type1="Full" data-type2="UnderOver" data-bet="Under" data-market="underover" style="margin-right:3px;">
                                                        <span class="live-left away-team-name">원정팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon4.png"></span><span class="under-rate"></span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr style="display:none ;" class="markets-underover-other">
                                    <td colspan="5" style="width: 100%; padding-left:15px; padding-right:15px;margin-bottom:10px;" height="40">
                                        <table>
                                            <tr>
                                                <td colspan="3" style="width: 100%; text-align: center;  height:30px;">오버/언더 기타 기준점</td>
                                            </tr>
                                            <tr style="display:none ;" class="underover-other-0">
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live over-' + gid + ' live-bet over">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon3.png"></span> <span  class="over-rate-0"></span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live draw-'+gid+' live-bet draw">
                                                        <span class="live-left">기준</span>
                                                        <span class="live-right overunder-option-0"></span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live under-' + gid + ' live-bet under" style="margin-right:3px;">
                                                        <span class="live-left away-team-name">원정팀명</span>
                                            ...
                                            <tr style="display:none ;" class="underover-other-1">
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live over-' + gid + ' live-bet over">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon3.png"></span> <span  class="over-rate-1">2.11</span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live draw-'+gid+' live-bet draw">
                                            ...
                                            <tr style="display:none ;" class="underover-other-2">
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live over-' + gid + ' live-bet over">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon3.png"></span> <span  class="over-rate-2">2.11</span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live draw-'+gid+' live-bet draw">
                                            ...
                                            <tr style="display:none ;" class="underover-other-3">
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live over-' + gid + ' live-bet over">
                                                        <span class="live-left home-team-name">홈팀명</span>
                                                        <span class="live-right"><span><img src="/img/pop_live_icon3.png"></span> <span  class="over-rate-3">2.11</span>
                                                    </div>
                                                </td>
                                                <td class="three-bet-btn">
                                                    <div class="bl_btn bl_text_btn long betting-btn-live draw-'+gid+' live-bet draw">
...
<script>
    ...
    function get_live_score(){
        $.ajax({
            ...
            async: true,
            dataType : 'json',
            data : 'mode=gameLiveScore&item=baseball',
            beforeSend : function(){
    ...
    function get_data(gid){
        ...
        $.ajax({
            type : 'post',
            url : '../proc/baseball.php',
            async: true,
            dataType : 'json',
            data : 'gid='+gid+'&item=baseball',
            success : function(data){
                //console.log(data)
                if(gid != $('#set_gid').val()) {
                    $(document).find('div').removeClass('active');
                    $('#selected_gid, #selected_type, #selected_code').text('');
                ...
                if(data['WDL']['suspended']==false){
                    ...
                    $('.away-rate').text(data['WDL']['drawRate']);
                    $('.markets-wdl').show();
                ...
                if(data['Handicap']['suspended']==false){
                    var cur_home_rate = cur_draw_rate = cur_away_rate = 1;
                    cur_home_rate = $('.home_handicap_rate').text();
                    cur_away_rate = $('.away_handicap_rate').text();
                    ...
                    //console.log(data['Handicap']['code'])

                    if(cur_home_rate != data['Handicap']['handiWin']) {
                        change_text_color('text-red-blink', $('.home_handicap_rate'));
                    }

                    if(cur_away_rate != data['Handicap']['handiLose']) {
                        change_text_color('text-blue-blink', $('.away_handicap_rate'));
                    }
                } else {
                ...
                if(data['UnderOver']['suspended']==false){
                    ...
                    if(cur_home_rate != data['UnderOver']['homeRate']) {
                        change_text_color('text-red-blink', $('.win-2st-rate'));
                    }
                    if(cur_draw_rate != data['UnderOver']['drawRate']) {
                        change_text_color('text-yellow-blink', $('.draw-2st-rate'));
                    }
                    if(cur_away_rate != data['UnderOver']['awayRate']) {
