<?php
    ...
    $where = " 1 AND c.GI_Key = 2 AND DATE_FORMAT(BG_BuyDate,'%Y-%m-%d') BETWEEN '{$startDate}' AND '{$endDate}'  ";
...
?>
    ...
    <div class="sub_bg">
        <div class="sub_wrap type2">
            <div class="sub_title">
                <div class="title1">파워사다리 베팅내역</div>
                <div class="title2">POWER LADDER BETTING LIST</div>
            </div>
            ...
            <div class="sub-box">
                ...
                <div class="mypage_menu3">
                    <a href="/mypage/branch/bet/minigame/power/">파워볼</a>
                    <a href="/mypage/branch/bet/minigame/pwladder/" class="active">파워사다리</a>
