...
?>
    ...
    <div class="sub_bg">
        <div class="sub_wrap type2">
            <div class="sub_title">
                <div class="title1">포인트 전환내역</div>
                <div class="title2">POINT CHANGE LIST</div>
            </div>
            <div class="sub-box">
                ...
                <div class="mypage_menu1">
                    ...
                    <a href="/mypage/point/exchangelist/" class="active">포인트내역</a>
                ...
                <div class="mypage_menu2">
                    ...
                    <a href="/mypage/point/list/" class="">포인트적립내역</a>
                    <a href="/mypage/point/exchangelist/" class="active">포인트전환내역</a>
                </div>
                        ...
                        if($total_article > 0){
                            ...
                            foreach($arr as $list){
                                ...
                                <tr>
                                    ...
                                    <td>보유머니전환</td>
                                    <td><font class="mypage-grnfont"><?php echo number_format($list['PI_Point']);?></font></td>
