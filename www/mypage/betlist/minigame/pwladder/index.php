<?php
    ...
    $where = " 1 AND b.GL_Key IN (11,12,13,14,15) AND DATE_FORMAT(BG_BuyDate,'%Y-%m-%d') BETWEEN '{$startDate}' AND '{$endDate}' AND BG_Visible = 1 ";
        ...
        <div class="sub_wrap type2">
            ...
            <div class="sub-box">
                ...
                <div class="mypage_menu3">
                    ...
                    <a href="/mypage/betlist/minigame/pwladder/" class="active">파워사다리</a>
