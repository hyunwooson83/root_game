<?php
    ...
    $where = " 1 AND c.GI_Key = 4 AND DATE_FORMAT(BG_BuyDate,'%Y-%m-%d') BETWEEN '{$startDate}' AND '{$endDate}' AND BG_Visible = 1 AND b.M_Key = '{$_SESSION['S_Key']}' ";
        ...
        <div class="sub_wrap type2">
            ...
            <div class="sub-box">
                ...
                <div class="mypage_menu3">
                    <a href="/mypage/betlist/minigame/power/" class="active">파워볼</a>
                    <a href="/mypage/betlist/minigame/pwladder/">파워사다리</a>
                    <!--<a href="/mypage/betlist/minigame/">스피드키노</a>-->
                    <a href="/mypage/betlist/minigame/kenoladder/">키노사다리</a>
                </div>
