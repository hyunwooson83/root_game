...
$where = " 1 AND M_Key = {$_SESSION['S_Key']} AND BG_Visible = '1' AND  BG_Gubun IN ('soccerw','dog','horse') ";
...
?>
    ...
    <div class="sub_bg">
        <div class="sub_wrap type2">
            <div class="sub_title">
                <div class="title1">가상게임 베팅내역</div>
                <div class="title2">VIRTUAL BOOK BETTING LIST</div>
            </div>
            <div class="sub-box">
                ...
                <div class="mypage_menu2">
                    <a href="/mypage/betlist/sports/" class="">스포츠게임</a>
                    <a href="/mypage/betlist/casino/" >카지노</a>
                    <a href="/mypage/betlist/minigame/power/">미니게임</a>
                    <a href="/mypage/betlist/virtual/" class="active" >가상게임</a>
                </div>
                ...
                <div class="board_wrap">
                    ...
                    <table class="table-black mypage">
                        ...
                        if(count($arr)>0){
                            foreach($arr as $rs) {
                                $sql = "SELECT * FROM buygamelist a LEFT JOIN gamelist_other b ON a.G_Key = b.G_Key LEFT JOIN gameleague c ON b.GL_Key = c.GL_Key_IDX WHERE a.M_Key = '{$_SESSION['S_Key']}' AND a.BG_Key = '{$rs['BG_Key']}'";
                                ...
                                foreach($ar as $list){
                                    ...
                                    if(in_array($list['BGL_ResultChoice'],array('Under','Over'))){
                                        $rate_win = number_format($list['BGL_QuotaUnder'],2);
                                        $rate_draw = '2.5';
                                        $rate_lose = number_format($list['BGL_QuotaOver'],2);
                                    ...
                                    if($rs['BG_Gubun']=='soccerw'){
                                        $game_type = '가상축구';
                                    } else if($rs['BG_Gubun']=='horse'){
                                        $game_type = '가상경마';
                                    } else if($rs['BG_Gubun']=='dog'){
                                        $game_type = '가상개경주';
                                    }
                                ...
                                <tr>
                                    <td colspan="7" class="table-left">
                                        ...
                                        <span>
                                            ...
                                            베팅일시&nbsp; : &nbsp;<font><?php echo date("Y년m월d일 H시i분",strtotime($rs['BG_BuyDate'])); ?></font>&nbsp; / &nbsp;게임구분 : <font><?php echo $game_type;?></font> / &nbsp; 베팅금액&nbsp; : &nbsp;<font><?php echo number_format($rs['BG_BettingPrice']); ?>원</font><BR/>
